...
const userTypeHiddenInput = document.getElementById('user-type'); //For form to decide which user is selected
let userType = null;
...
createAccountButton.addEventListener('click', () => {
    const userType = createAccountButton.dataset.userType;
