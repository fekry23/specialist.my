@props(['applicant_action', 'selected_applicant'])
...
<div class="tw-w-full md:tw-w-1/3 tw-mx-auto">
    <div class="tw-flex tw-flex-col tw-p-5 tw-rounded-lg tw-shadow tw-bg-white">
        <div class="tw-flex tw-flex-col tw-items-center tw-text-center">
            ...
            <p class="tw-mt-2 tw-text-sm tw-text-gray-600 tw-leading-relaxed">Do you really want to
                {{ strtolower($applicant_action) }} this
                specialist? This process cannot be undone.</p>
        </div>
        ...
        <div class="tw-flex tw-items-center tw-mt-3 tw-justify-center">
            ...
            <div>
                ...
                <form method="POST"
                    action="{{ route('employer.update_applicant_status', ['job_id' => $selected_applicant->job_id, 'trainer_id' => $selected_applicant->trainer_id, 'applicant_action' => $applicant_action]) }}">
                    @csrf
                    @method('PUT')
                    <button id="agree-btn"
