        ...
        <div class="tw-flex tw-flex-col tw-p-12 tw-min-w-[85%]">
            ...
            <div class="tw--my-2 tw-py-2 tw-overflow-x-auto sm:tw--mx-6 sm:tw-px-6 lg:tw--mx-8 lg:tw-px-8">
                ...
                <div
                    ...
                    <div class="tw-flex">
                        {{-- search bar --}}
                        <form action="{{ route('trainer.search_active_jobs') }}" method="GET" class="tw-flex tw-w-full">
                            <label for="keywords"
                ...
                <div
                    ...
                    <table id="active-jobs-table" class="tw-min-w-full">
                        ...
                        <thead>
                            <tr>
                                <th
                                    class="tw-px-6 tw-py-3 tw-border-b-2 tw-border-gray-300 tw-text-left tw-leading-4 tw-text-blue-500 tw-tracking-wider tw-auto">
                                    ID
                                </th>
                                <th
                            ...
                            @else
                                @foreach ($active_jobs as $active_job)
                                    ...
                                    <tr class="tw-border-b-4 {{ $rowClass }}">
                                        <x-trainers.jobs-table-row :job="$active_job" />
                                    </tr>
                                @endforeach
                            @endif
                        </tbody>
